...
Revision ID: 1fb69a3a2f03
Revises: 
Create Date: 2025-03-27 06:08:41.502751
...
def upgrade():
    ...
    sa.Column('verification_token', sa.String(length=6), nullable=True),
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.create_index('idx_verification', ['verification_token', 'verification_expires_at'], unique=False)
